...
export const countries: Country[] = [
  ...
  { name: "Czechia (Czech Republic)", flag: "🇨🇿", code: "CZ" },
  ...
  { name: "Eswatini (fmr. Swaziland)", flag: "🇸🇿", code: "SZ" },
  ...
  { name: "Myanmar (formerly Burma)", flag: "🇲🇲", code: "MM" },
  ...
  { name: "Palestine State", flag: "🇵🇸", code: "PS" },
